...
public interface EventMapper {
     ...
     * @return 影响的行数
     */
    @Insert("INSERT INTO event(name, event_date, description, appearance_count, importance) " +
            "VALUES(#{name}, #{eventDate}, #{description}, #{appearanceCount}, #{importance})")
     ...
     * @return 影响的行数
     */
    @Update("UPDATE event SET name=#{name}, event_date=#{eventDate}, description=#{description}, " +
