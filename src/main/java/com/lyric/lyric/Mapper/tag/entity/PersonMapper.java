...
public interface PersonMapper {
         ...
         * @return 人物列表
         */
        @Select("SELECT * FROM person WHERE relation LIKE CONCAT('%', #{relation}, '%')")
         ...
         * @return 人物列表
         */
        @Select("SELECT * FROM person WHERE name = #{name} AND relation LIKE CONCAT('%', #{relation}, '%')")
         ...
         * @return 关联的活动数量
         */
        @Select("SELECT COUNT(*) FROM activity_person WHERE person_id = #{personId}")
        int countActivitiesByPersonId(Integer personId);
         ...
         * @return 匹配的人物列表
         */
        @Select("SELECT * FROM person WHERE name LIKE CONCAT('%', #{keyword}, '%') OR alias LIKE CONCAT('%', #{keyword}, '%')")
        List<PersonPojo> searchByKeyword(String keyword);
}